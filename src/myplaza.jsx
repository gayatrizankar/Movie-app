    ...
    <div>
      ...
      <div className='h-screen w-full bg-gray-800'>
        ...
        <div className='flex flex-col items-center justify-center'>
            <p className='text-5xl font-serif font-bold text-white p-10'>Welcome</p>
            <p className='text-2xl text-white pb-5 '>Sigin to get started</p>
            <button onClick={()=>{navigate('/signin')}} className='h-[50px] w-[100px] rounded-xl p-2 bg-yellow-700 m-10 font-bold text-white'>Sign In</button>
        </div>
